...
DATAMINRPULSE_ALERT_VERSION = 14
DATAMINRPULSE_GET_LISTS = f"/account/2/get_lists?alertversion={DATAMINRPULSE_ALERT_VERSION}"
DATAMINRPULSE_GET_ALERTS = f"/api/3/alerts?alertversion={DATAMINRPULSE_ALERT_VERSION}"
DATAMINRPULSE_GET_RELATED_ALERTS = f"/alerts/2/get_related?alertversion={DATAMINRPULSE_ALERT_VERSION}"
...
DATAMINRPULSE_ERROR_MESSAGE_UNAVAILABLE = "Error message unavailable. Please check the asset configuration and|or action parameters"
DATAMINRPULSE_ERROR_GENERAL_MESSAGE = "Status code: {0}, Data from server: {1}"
